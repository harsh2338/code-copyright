...
//       filesMap[fileCount] = CodeFile(fileCount,_fileSize,_fileIPFSHash, _fileName, _fileDescription,msg.sender/*_msgSender()*/,block.timestamp,_codeFingerPrint,_hashSet);

//       emit CodeFileUploadEvent(fileCount,_fileSize,_fileIPFSHash, _fileName, _fileDescription,,msg.sender/*_msgSender()*/,block.timestamp,_codeFingerPrint,_hashSet);
//     }
//   }
...
//               list2[setLength2]=l2[i];//               setLength2++;
//             }
//         } 
